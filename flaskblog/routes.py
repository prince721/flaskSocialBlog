...
#         return redirect(url_for('home'))
#
#     return render_template('newORupdate_post.html', form=form, legend='New Post')
#
#
...
#
#     return render_template('newORupdate_post.html', form=form, legend='Update Post')
#
#
...
#
#
# def send_emailtoken(user):
#     token = user.set_token()
#     msg = Message('Password Reset Request',
#                   sender='barney47457@gmail.com',
...
#     if user is None:
#         flash('The link is invalid or is expired', 'warning')
#         return redire ct(url_for('request_reset'))
